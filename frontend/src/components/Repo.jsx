	...
	return (
		<li className='mb-10 ms-7'>
			...
			<div className='flex gap-2 items-center flex-wrap'>
				<a
					href={"https://github.com/chiraaax/MernPro-CRUD-App"}
					target='_blank'
					rel='noreferrer'
			...
			<p className='mb-4 text-base font-normal text-gray-500'>Starter MERN Stack Online application for Online Shopping Platform - CRUD operations</p>
